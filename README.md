...
| [FragPipe](https://github.com/Nesvilab/philosopher/) | [Manual](https://github.com/wenbostar/PDV/wiki/Visualize-FragPipe-result) |
...
| [Sage](https://github.com/lazear/sage) (>=v0.14.6) | mgf, mgf.gz, mzML or mzML.gz : `results.sage.tsv`. Several spectrum files of one search can be loaded together; gzipped files are decompressed automatically. Select **Sage** as the file type in the database import dialog, where decoys (`label = -1`) and hits above 1% `spectrum_q` can be excluded on import |
